...
describe Membership do
  before :each do
    Settings.system_roles.each { |k, membership_name| Membership.create( :name => membership_name).update_attribute(:status, 1) }
  end
  
  it "以 Settings.system_roles 的 key 作为方法名来获取 Membership 中相应的角色记录" do
